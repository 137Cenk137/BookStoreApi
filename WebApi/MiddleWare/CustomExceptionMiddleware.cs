...
public class CustomExceptionMiddleware
{
    ...
    public async Task Invoke(HttpContext context) 
    {
        ...
        try
        {
            ...
            watch.Stop();
            message = "[Request] HTTP " + context.Request.Method.ToString() + "-" + context.Request.Path.ToString() + " responded " + context.Response.StatusCode.ToString()+" in "+ watch.Elapsed.Milliseconds+" ms";
            Console.WriteLine(message);
